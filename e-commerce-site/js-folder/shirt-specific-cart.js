let productsArr =[
 //==========its index is 0===========//
 {
  pImg: '../assets-folder/shirt1.png',
  name: 'kids shirt',
  Price: '₹200',
  spSec:{
   name: 'mens home wear t-shirt',
    sliderimages:[
     {
     img: '../assets-folder/shirt1.png',
     },
     {
     img: '../assets-folder/shirt-sp1.png',
     },
     {
     img: '../assets-folder/shirt-sp3.png',
     },
    ],//slider images
   about: 'This shirt is comfortable to wear for kids. You can wear this shirt in summer season without any problem. This shirt is of light colour.',
   suggest:{
    a: 1,
    b: 2,
    c: 3,
 ...
 //==========its index is 1===========//
 {
  ...
  spSec:{
   name: 'mens home wear t-shirt',
    sliderimages:[
     {
     img: '../assets-folder/shirt2.png',
     },
     {
     img: '../assets-folder/shirt-sp5.png',
     },
     {
     img: '../assets-folder/shirt-sp6.png',
     },
    ],//slider images
   about: 'This shirt is comfortable to wear for kids. You can wear this shirt in summer season without any problem. This shirt is of light colour.',
   suggest:{
 ...
 //==========its index is 2===========//
 {
  ...
  spSec:{
   name: 'mens home wear t-shirt',
    sliderimages:[
     {
     img: '../assets-folder/shirt3.png',
     },
     {
     img: '../assets-folder/shirt-sp7.png',
     },
    ],//slider images
   about: 'This shirt is comfortable to wear for kids. You can wear this shirt in summer season without any problem. This shirt is of light colour.',
   suggest:{
 ...
 //==========its index is 3===========//
 {
  ...
  spSec:{
   name: 'mens home wear t-shirt',
    sliderimages:[
     {
     img: '../assets-folder/shirt4.png',
     },
     {
     img: '../assets-folder/shirt-sp8.png',
     },
    ],//slider images
   about: 'This shirt is comfortable to wear for kids. You can wear this shirt in summer season without any problem. This shirt is of light colour.',
   suggest:{
 ...
 //==========its index is 4===========//
 {
  ...
  spSec:{
   name: 'mens home wear t-shirt',
    sliderimages:[
     {
     img: '../assets-folder/shirt5.png',
     },
     {
     img: '../assets-folder/shirt-sp10.png',
     },
    ],//slider images
   about: 'This shirt is comfortable to wear for kids. You can wear this shirt in summer season without any problem. This shirt is of light colour.',
   suggest:{
 ...
 //==========its index is 5===========//
 {
  ...
  spSec:{
   name: 'mens home wear t-shirt',
    sliderimages:[
     {
     img: '../assets-folder/shirt6.png',
     },
     {
     img: '../assets-folder/shirt-sp11.png',
     },
     {
     img: '../assets-folder/shirt-sp12.png',
     },
    ],//slider images
   about: 'This shirt is comfortable to wear for kids. You can wear this shirt in summer season without any problem. This shirt is of light colour.',
   suggest:{
