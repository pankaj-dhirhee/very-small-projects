let productsArr =[
 //------its index is 0------//
 {
  pImg: '../assets-folder/frock1.png',
  name: 'kids frock',
  Price: '₹800',
  spSec:{
   name: 'kids home wear frock',
    sliderimages:[
     {
     img: '../assets-folder/frock1.png',
     },
     {
     img: '../assets-folder/frock-sp1.png',
     },
     {
     img: '../assets-folder/frock-sp2.png',
     },
    ],//slider images
   about: 'This frock is comfortable to wear. You can wear for kids. this frock in partys  without any problem. This frock is of light colour.',
   suggest:{
    a: 1,
    b: 2,
    c: 3,
 ...
 //------its index is 1------//
 {
  ...
  spSec:{
   name: 'kids home wear frock',
    sliderimages:[
     {
     img: '../assets-folder/frock2.png',
     },
     {
     img: '../assets-folder/frock-sp13.png',
     },
     {
     img: '../assets-folder/frock-sp14.png',
     },
    ],//slider images
   about: 'This frock is comfortable to wear. You can wear for kids. this frock in partys  without any problem. This frock is of light colour.',
   suggest:{
 ...
 //------its index is 2------//
 {
  ...
  spSec:{
   name: 'kids home wear frock',
    sliderimages:[
     {
     img: '../assets-folder/frock3.png',
     },
     {
     img: '../assets-folder/frock-sp6.png',
     },
    ],//slider images
   about: 'This frock is comfortable to wear. You can wear for kids. this frock in partys  without any problem. This frock is of light colour.',
   suggest:{
  ...
  //------its index is 3------//
 {
  ...
  spSec:{
   name: 'kids home wear frock',
    sliderimages:[
     {
     img: '../assets-folder/frock4.png',
     },
     {
     img: '../assets-folder/frock-sp7.png',
     },
     {
     img: '../assets-folder/frock-sp5.png',
     },
    ],//slider images
   about: 'This frock is comfortable to wear. You can wear for kids. this frock in partys  without any problem. This frock is of light colour.',
   suggest:{
 ...
 //------its index is 4------//
 {
  pImg: '../assets-folder/frock-sp10.png',
  name: 'kids frock',
  Price: '₹1000',
  spSec:{
   name: 'kids home wear frock',
    sliderimages:[
     {
     img: '../assets-folder/frock-sp10.png',
     },
     {
     img: '../assets-folder/frock-sp9.png',
     },
     {
     img: '../assets-folder/frock-sp8.png',
     },
    ],//slider images
   about: 'This frock is comfortable to wear. You can wear for kids. this frock in partys  without any problem. This frock is of light colour.',
   suggest:{
 ...
 //------its index is 5------//
 {
  ...
  spSec:{
   name: 'kids home wear frock',
    sliderimages:[
     {
     img: '../assets-folder/frock4.jpg',
     },
     {
     img: '../assets-folder/frock-sp11.png',
     },
     {
     img: '../assets-folder/frock-sp12.png',
     },
     {
     img: '../assets-folder/frock-sp13.jpg',
     },
    ],//slider images
   about: 'This frock is comfortable to wear. You can wear for kids. this frock in partys  without any problem. This frock is of light colour.',
   suggest:{
