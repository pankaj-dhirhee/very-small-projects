let productsArr =[
  //------its index is 0------//
 {
  pImg: '../assets-folder/kids-shirt1.png',
  name: 'kids shirt',
  Price: '₹170',
  spSec:{
   name: 'kids home wear shirt',
    sliderimages:[
     {
     img: '../assets-folder/kids-shirt1.png',
     },
     {
     img: '../assets-folder/kids-shirt-sp1.png',
     },
    ],//slider images
   about: 'This shirt is comfortable to wear. You can wear for kids. this shirt in partys  without any problem. This frock is of light colour.',
   suggest:{
    a: 1,
    b: 2,
    c: 3,
 ...
 //------its index is 1------//
 {
  pImg: '../assets-folder/kids-shirt2.png',
  name: 'kids shirt',
  Price: '₹573',
  spSec:{
   name: 'kids home wear shirt',
    sliderimages:[
     {
     img: '../assets-folder/kids-shirt2.png',
     },
     {
     img: '../assets-folder/kids-shirt-sp2.png',
     },
     {
     img: '../assets-folder/kids-shirt-sp3.png',
     },
    ],//slider images
   about: 'This shirt is comfortable to wear. You can wear for kids. this shirt in partys  without any problem. This frock is of light colour.',
   suggest:{
 ...
 //------its index is 2------//
 {
  pImg: '../assets-folder/kids-shirt3.png',
  name: 'kids shirt',
  Price: '₹350',
  spSec:{
   name: 'kids home wear shirt',
    sliderimages:[
     {
     img: '../assets-folder/kids-shirt3.png',
     },
     {
     img: '../assets-folder/slider-kids-shirt-sp4.png',
     },
     {
     img: '../assets-folder/slider-kids-shirt-sp5.png',
     },
    ],//slider images
   about: 'This shirt is comfortable to wear. You can wear for kids. this shirt in partys  without any problem. This frock is of light colour.',
   suggest:{
 ...
 //------its index is 3------//
 {
  pImg: '../assets-folder/kids-shirt4.png',
  name: 'kids shirt',
  Price: '₹290',
  spSec:{
   name: 'kids home wear shirt',
    sliderimages:[
     {
     img: '../assets-folder/kids-shirt4.png',
     },
     {
     img: '../assets-folder/slider-kids-shirt-sp6.png',
     },
     {
     img: '../assets-folder/slider-kids-shirt-sp7.png',
     },
    ],//slider images
   about: 'This shirt is comfortable to wear. You can wear for kids. this shirt in partys  without any problem. This frock is of light colour.',
   suggest:{
 ...
 //------its index is 4------//
 {
  pImg: '../assets-folder/kids-shirt5.png',
  name: 'kids shirt',
  Price: '₹820',
  spSec:{
   name: 'kids home wear shirt',
    sliderimages:[
     {
     img: '../assets-folder/kids-shirt5.png',
     },
     {
     img: '../assets-folder/slider-kids-shirt-sp8.png',
     },
     {
     img: '../assets-folder/slider-kids-shirt-sp9.png',
     },
    ],//slider images
   about: 'This shirt is comfortable to wear. You can wear for kids. this shirt in partys  without any problem. This frock is of light colour.',
   suggest:{
 ...
 //------its index is 5------//
 {
  pImg: '../assets-folder/kids-shirt6.png',
  name: 'kids shirt',
  Price: '₹339',
  spSec:{
   name: 'kids home wear shirt',
    sliderimages:[
     {
     img: '../assets-folder/kids-shirt6.png',
     },
     {
     img: '../assets-folder/kids-shirt6.png',
     },
